...
package org.taylor.nora.auth.config;
...
public class SwaggerConfiguration {
    ...
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("org.taylor.nora.auth.controller"))
    ...
    private ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                .title("Nora auth")
                .description("<div style='font-size:14px;color:red;'>Nora auth RESTful APIs</div>")
